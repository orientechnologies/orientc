...
{
	public:
	virtual void className(char * name){this->class_name = name;}
	virtual void startField(char * name,OType type){this->field_count++;}
	...
	int field_count;
	char * class_name;
	TrackerListener():field_count(0),class_name(0){}
};
